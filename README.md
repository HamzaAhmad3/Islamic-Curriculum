...
### Posting a note on the Dashboard

Add a new file in `src/content/notes/`, e.g. `src/content/notes/2026-08-update.md`:

```markdown
---
title: "New books added"
date: 2026-08-01
pinned: false   # true keeps it at the top regardless of date
---

Whatever you want visitors to see — an update, a reminder, an announcement. Plain
Markdown paragraphs.
```

Notes sort pinned-first, then newest-first. Delete the file (or set an older `date`) when a
